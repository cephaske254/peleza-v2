...
import KTLayoutHeader from './base/header'
import KTLayoutHeaderMenu from './base/header-menu'
import KTLayoutHeaderTopbar from './base/header-topbar'
import KTLayoutSubheader from './base/subheader'
import KTLayoutBrand from './base/brand'
import KTLayoutAside from './base/aside'
import KTLayoutAsideMenu from './base/aside-menu'
import KTLayoutAsideToggle from './base/aside-toggle'
import KTLayoutFooter from './base/footer'
import KTLayoutContent from './base/content'
import KTLayoutSidebar from './base/sidebar'
// import KTLayoutScrolltop from '../components/scrolltop'
import KTLayoutStickyCard from './base/sticky-card'
import KTLayoutStretchedCard from './base/stretched-card'
