    ...
    >
      ...
      <div class="topbar">
        ...
        <div class="dropdown mr-1">
          ...
          >
            <div
              class="btn btn-icon btn-clean btn-dropdown btn-lg pulse pulse-primary"
            >
              <span class="svg-icon svg-icon-xl svg-icon-primary">
                <!--begin::Svg Icon | path:assets/media/svg/icons/Code/Compiling.svg-->
                <svg
          ...
          >
            <form>
              ...
              <div
                ...
                style="background-image: url(assets/media/misc/bg-3.jpg)"
              >
                <!--begin::Title-->
                ...
                <!--begin::Tabs-->
                <ul
                  class="nav nav-bold nav-tabs nav-tabs-line nav-tabs-line-3x nav-tabs-line-transparent-white nav-tabs-line-active-border-success mt-3 px-8 font-size-lg"
                  role="tablist"
                >
                  <li class="nav-item">
                    <a
              ...
              <div class="tab-content">
                    ...
                    <div class="d-flex align-items-center mb-6">
                      ...
                      <div class="d-flex flex-wrap flex-row-fluid">
                        ...
                        <div class="d-flex align-items-center py-2">
                          <!--begin::Label-->
                          <span
                            class="text-danger font-weight-bolder font-size-sm pr-6"
                            >-34%</span
                          >
                          <!--end::Label-->
                          <!--begin::Btn-->
                    ...
                    <div class="d-flex align-items-center mb-6">
                      ...
                      <div class="d-flex flex-wrap flex-row-fluid">
                        ...
                        <div class="d-flex align-items-center py-2">
                          <!--begin::Label-->
                          <span
                            class="text-info font-weight-bolder font-size-sm pr-6"
                            >+34%</span
                          >
                          <!--end::Label-->
                          <!--begin::Btn-->
                  ...
                  >
                    ...
                    <div class="d-flex align-items-center mb-6">
                      ...
                      <div class="d-flex flex-column font-weight-bold">
                        ...
                        <span class="text-muted"
                          >Project campaign planning</span
                        >
                      </div>
                      <!--end::Text-->
                    </div>
                    ...
                    <div class="d-flex align-items-center mb-6">
                      ...
                      <div class="d-flex flex-column font-weight-bold">
                        ...
                        >
                        <span class="text-muted"
                          >Reporting Dashboard App Planning</span
                        >
                      </div>
                      <!--end::Text-->
                    </div>
                    ...
                    <div class="d-flex align-items-center mb-6">
                      ...
                      <div class="d-flex flex-column font-weight-bold">
                        ...
                        >
                        <span class="text-muted"
                          >System Analytics &amp; Development</span
                        >
                      </div>
                      <!--end::Text-->
                    </div>
                ...
                >
                  ...
                  >
                    All caught up! <br />No new messages.
                  </div>
                  <!--end::Nav-->
                </div>
                <!--end::Tabpane-->
        ...
        <div class="dropdown mr-1">
          ...
          >
            <!--begin:Header-->
            <div
              class="d-flex flex-column flex-center py-10 rounded-to border-bottom"
            >
              <h4 class="text-dark font-weight-bold">Quick Actions</h4>
              <span
                class="btn btn-primary btn-sm font-weight-bold font-size-sm mt-2"
                >23 new tasks</span
              >
            </div>
            <!--end:Header-->
        ...
        <div class="topbar-item ml-4">
          <div
            class="btn btn-icon btn-light-primary h-40px w-40px p-0"
