  ...
  <div id="kt_quick_panel" class="offcanvas offcanvas-right pt-5 pb-10">
		...
		<div class="offcanvas-content px-10">
			<div class="tab-content">
				<!--begin::Tabpane-->
				<div class="tab-pane fade show pt-3 pr-5 mr-n5 active scroll ps ps--active-y" id="kt_quick_panel_logs" role="tabpanel" style="height: 281px; overflow: hidden;">
					<!--begin::Section-->
					<div class="mb-15">
					...
					<!--end::Section-->
				<div class="ps__rail-x" style="left: 0px; bottom: 0px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 0px; height: 281px; right: 0px;"><div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 92px;"></div></div></div>
				<!--end::Tabpane-->
				<!--begin::Tabpane-->
				<div class="tab-pane fade pt-2 pr-5 mr-n5 scroll ps" id="kt_quick_panel_notifications" role="tabpanel" style="height: 281px; overflow: hidden;">
					<!--begin::Nav-->
				...
				<!--end::Tabpane-->
				<!--begin::Tabpane-->
				<div class="tab-pane fade pt-3 pr-5 mr-n5 scroll ps" id="kt_quick_panel_settings" role="tabpanel" style="height: 281px; overflow: hidden;">
					<form class="form">
						<!--begin::Section-->
						<div class="pt-1">
