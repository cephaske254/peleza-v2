    ...
    <div class="offcanvas-content pr-5 mr-n5">
      ...
      <div class="d-flex align-items-center mt-5">
        <div class="symbol symbol-100 mr-5">
          <div
            class="symbol-label"
            style="background-image: url('assets/media/users/150-6.jpg')"
          ></div>
      ...
      <div class="pt-5">
        ...
        <div class="bg-gray-100 d-flex align-items-center p-5 rounded gutter-b">
          ...
          <div class="ml-1">
            ...
            <p class="m-0 text-dark-50 font-weight-bold">
        ...
        <div class="bg-gray-100 d-flex align-items-center p-5 rounded gutter-b">
          ...
          >
            ...
            <span
              class="svg-icon svg-icon-lg svg-icon-danger position-absolute"
            >
        ...
        <div class="bg-gray-100 d-flex align-items-center p-5 rounded gutter-b">
          ...
          >
            ...
            <span
              class="svg-icon svg-icon-lg svg-icon-success position-absolute"
            >
