  ...
  >
    ...
    >
      ...
      <div
        ...
        style="height: 294px; overflow: hidden"
      >
        <!--begin::Menu Nav-->
        <ul class="menu-nav">
          ...
          >
            ...
            <div class="menu-submenu">
              ...
              <ul class="menu-subnav">
                ...
                <li class="menu-item" aria-haspopup="true">
                  <a
                    href="layout/general/expanded-sidebar.html"
                    class="menu-link"
                  >
                    <i class="menu-bullet menu-bullet-dot">
                      <span></span>
          ...
          <li class="menu-item" aria-haspopup="true">
            <a
              target="_blank"
              href="https://preview.keenthemes.com/keen/demo1/builder.html"
              class="menu-link"
            >
              <span class="svg-icon menu-icon">
                ...
                >
                  ...
                  <div class="menu-submenu">
                    ...
                    <ul class="menu-subnav">
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/forms/controls/base.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/forms/controls/input-group.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/forms/controls/checkbox.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/forms/controls/radio.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/forms/controls/switch.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/forms/controls/option.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                ...
                >
                  ...
                  <div class="menu-submenu">
                    ...
                    <ul class="menu-subnav">
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/forms/widgets/bootstrap-datetimepicker.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/forms/widgets/bootstrap-datepicker.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/forms/widgets/bootstrap-timepicker.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/forms/widgets/bootstrap-daterangepicker.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/forms/widgets/tagify.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/forms/widgets/bootstrap-touchspin.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/forms/widgets/bootstrap-maxlength.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/forms/widgets/bootstrap-switch.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/forms/widgets/bootstrap-multipleselectsplitter.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/forms/widgets/bootstrap-select.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/forms/widgets/select2.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/forms/widgets/typeahead.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/forms/widgets/nouislider.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/forms/widgets/form-repeater.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/forms/widgets/ion-range-slider.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/forms/widgets/input-mask.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/forms/widgets/jquery-mask.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/forms/widgets/autosize.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/forms/widgets/clipboard.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/forms/widgets/recaptcha.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                ...
                >
                  ...
                  <div class="menu-submenu">
                    ...
                    <ul class="menu-subnav">
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/forms/editors/tinymce.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      >
                        ...
                        <div class="menu-submenu">
                          ...
                          <ul class="menu-subnav">
                            <li class="menu-item" aria-haspopup="true">
                              <a
                                href="features/forms/editors/ckeditor-classic.html"
                                class="menu-link"
                              >
                                <i class="menu-bullet menu-bullet-line">
                                  <span></span>
                            ...
                            <li class="menu-item" aria-haspopup="true">
                              <a
                                href="features/forms/editors/ckeditor-inline.html"
                                class="menu-link"
                              >
                                <i class="menu-bullet menu-bullet-line">
                                  <span></span>
                            ...
                            <li class="menu-item" aria-haspopup="true">
                              <a
                                href="features/forms/editors/ckeditor-balloon.html"
                                class="menu-link"
                              >
                                <i class="menu-bullet menu-bullet-line">
                                  <span></span>
                            ...
                            <li class="menu-item" aria-haspopup="true">
                              <a
                                href="features/forms/editors/ckeditor-balloon-block.html"
                                class="menu-link"
                              >
                                <i class="menu-bullet menu-bullet-line">
                                  <span></span>
                            ...
                            <li class="menu-item" aria-haspopup="true">
                              <a
                                href="features/forms/editors/ckeditor-document.html"
                                class="menu-link"
                              >
                                <i class="menu-bullet menu-bullet-line">
                                  <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/forms/editors/quill.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/forms/editors/summernote.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/forms/editors/bootstrap-markdown.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                ...
                >
                  ...
                  <div class="menu-submenu">
                    ...
                    <ul class="menu-subnav">
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/forms/layouts/default-forms.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/forms/layouts/multi-column-forms.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/forms/layouts/action-bars.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/forms/layouts/sticky-action-bar.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                ...
                >
                  ...
                  <div class="menu-submenu">
                    ...
                    <ul class="menu-subnav">
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/forms/validation/states.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/forms/validation/form-controls.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/forms/validation/form-widgets.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                ...
                >
                  ...
                  <div class="menu-submenu">
                    ...
                    <ul class="menu-subnav">
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/ktdatatable/base/data-local.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/ktdatatable/base/data-json.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/ktdatatable/base/data-ajax.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/ktdatatable/base/html-table.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/ktdatatable/base/local-sort.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/ktdatatable/base/translation.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                ...
                >
                  ...
                  <div class="menu-submenu">
                    ...
                    <ul class="menu-subnav">
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/ktdatatable/advanced/record-selection.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/ktdatatable/advanced/row-details.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/ktdatatable/advanced/modal.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/ktdatatable/advanced/column-rendering.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/ktdatatable/advanced/column-width.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/ktdatatable/advanced/vertical.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                ...
                >
                  ...
                  <div class="menu-submenu">
                    ...
                    <ul class="menu-subnav">
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/ktdatatable/child/data-local.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/ktdatatable/child/data-ajax.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                ...
                >
                  ...
                  <div class="menu-submenu">
                    ...
                    <ul class="menu-subnav">
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/ktdatatable/api/methods.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/ktdatatable/api/events.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                ...
                >
                  ...
                  <div class="menu-submenu">
                    ...
                    <ul class="menu-subnav">
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/datatables/basic/basic.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/datatables/basic/scrollable.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/datatables/basic/headers.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/datatables/basic/paginations.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                ...
                >
                  ...
                  <div class="menu-submenu">
                    ...
                    <ul class="menu-subnav">
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/datatables/advanced/column-rendering.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/datatables/advanced/multiple-controls.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/datatables/advanced/column-visibility.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/datatables/advanced/row-callback.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/datatables/advanced/row-grouping.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/datatables/advanced/footer-callback.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                ...
                >
                  ...
                  <div class="menu-submenu">
                    ...
                    <ul class="menu-subnav">
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/datatables/data-sources/html.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/datatables/data-sources/javascript.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/datatables/data-sources/ajax-client-side.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/datatables/data-sources/ajax-server-side.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                ...
                >
                  ...
                  <div class="menu-submenu">
                    ...
                    <ul class="menu-subnav">
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/datatables/search-options/column-search.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/datatables/search-options/advanced-search.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                ...
                >
                  ...
                  <div class="menu-submenu">
                    ...
                    <ul class="menu-subnav">
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/datatables/extensions/buttons.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/datatables/extensions/colreorder.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/datatables/extensions/keytable.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/datatables/extensions/responsive.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/datatables/extensions/rowgroup.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/datatables/extensions/rowreorder.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/datatables/extensions/scroller.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
                      ...
                      <li class="menu-item" aria-haspopup="true">
                        <a
                          href="features/datatables/extensions/select.html"
                          class="menu-link"
                        >
                          <i class="menu-bullet menu-bullet-dot">
                            <span></span>
        ...
        <div class="ps__rail-y" style="top: 0px; height: 294px; right: 4px">
          <div
            class="ps__thumb-y"
            tabindex="0"
            style="top: 0px; height: 79px"
          ></div>
        </div>
      </div>
      <!--end::Menu Container-->
