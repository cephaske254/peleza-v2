  ...
  <div class="container">
      ...
      <div class="col-lg-4">
        ...
        <div class="card card-custom card-stretch gutter-b">
          ...
          <div class="card-header border-0 pt-6">
            <h3 class="card-title">
              <span
                class="card-label font-weight-bolder font-size-h4 text-dark-75"
                >Weekly Sales</span
              >
            </h3>
          ...
          >
            <!--begin::label-->
            <span
              class="font-weight-bolder display5 text-dark-75 py-4 pl-5 pr-5"
            >
              <span class="font-weight-normal font-size-h6 text-muted pr-1"
                >$</span
              >64M</span
            >
            <!--end::label-->
          ...
          <div class="card-body pt-6">
            ...
            <ul class="nav nav-pills nav-fill flex-nowrap">
              ...
              <li class="nav-item w-90px">
                <a
                  class="nav-link active d-flex flex-column shadow-sm h-80px"
                  data-toggle="tab"
              ...
              <li class="nav-item w-90px mx-5">
                <a
                  class="nav-link d-flex flex-column shadow-sm h-80px"
                  data-toggle="tab"
              ...
              >
                ...
                >
                  ...
                  <div class="d-flex align-items-center">
                    <span
                      class="text-muted mr-3 font-size-sm font-weight-bolder"
                      >65%</span
                    >
            ...
            <div class="card-toolbar">
              <ul class="nav nav-pills nav-pills-sm nav-dark">
                <li class="nav-item ml-0">
                  <a
                    class="nav-link py-2 px-4 font-weight-bolder font-size-sm"
                    data-toggle="tab"
                ...
                <li class="nav-item">
                  <a
                    class="nav-link py-2 px-4 active font-weight-bolder font-size-sm"
                    data-toggle="tab"
    ...
    <div class="row">
      <div class="col-lg-4">
        ...
        <div class="card card-custom card-stretch gutter-b">
          ...
          <div class="card-body">
            ...
            >
              ...
              >
                <!--begin::Label-->
                <span
                  class="font-size-h6 text-muted font-weight-bolder text-uppercase pr-2"
                  >Announcements</span
                >
                <!--end::Label-->
                <!--begin::Action-->
          ...
          >
            ...
            >
            <!--end::Label-->
            <a href="#" class="btn btn-sm btn-primary font-weight-bolder px-6"
              >Join</a
            >
          </div>
          <!--end::Footer-->
        ...
        <div class="card card-custom card-stretch gutter-b">
          ...
          <div class="card-footer border-0 pt-0">
            ...
            <div class="flex-grow-1">
              <!--begin::Text-->
              <div class="text-muted font-weight-bold font-size-lg pb-4">
                Progress
              </div>
              <!--begendin::Text-->
              <!--begin::Progress-->
      ...
      <div class="col-lg-4">
        ...
        <div class="card card-custom card-stretch gutter-b">
          ...
          >
            <!--begin::Label-->
            <span class="text-muted font-size-lg font-weight-bold pr-2"
    ...
    <div class="card card-custom gutter-b">
      ...
      <div class="card-body py-0">
        ...
        <div class="table-responsive">
          <table
            class="table table-borderless table-head-custom table-vertical-center"
              ...
              <tr>
                ...
                <td class="">
                  <div class="d-flex flex-column w-100 mr-2">
                    ...
                    >
                      <span
                        class="text-muted mr-2 font-size-sm font-weight-bolder"
                        >79%</span
                      >
                ...
                <div class="dropdown-menu dropdown-menu-md dropdown-menu-right">
                  ...
                  <ul class="navi navi-hover navi-active navi-accent">
                    ...
                    <li class="navi-footer pt-5 pb-4">
                      <a
                        class="btn btn-light-primary font-weight-bolder btn-sm px-5"
                        href="#"
                        >More options</a
                      >
                      <a
          ...
          <div class="card-body pt-5">
            ...
            <div class="d-flex align-items-center mb-6">
              ...
              <div class="d-flex flex-wrap flex-row-fluid">
                ...
                <div class="d-flex align-items-center py-2">
                  <!--begin::Label-->
                  <span
                    class="text-success font-weight-bolder font-size-sm pr-6"
                    >+65%</span
                  >
                  <!--end::Label-->
                  <!--begin::Btn-->
            ...
            <div class="d-flex align-items-center mb-6">
              ...
              <div class="d-flex flex-wrap flex-row-fluid">
                ...
                <div class="d-flex align-items-center py-2">
                  <!--begin::Label-->
                  <span class="text-danger font-weight-bolder font-size-sm pr-6"
                    >-34%</span
                  >
                  <!--end::Label-->
                  <!--begin::Btn-->
                  ...
                  <ul class="navi navi-hover">
                    ...
                    <li class="navi-item">
                      <a href="#" class="navi-link">
                        ...
                        <span class="navi-link-badge">
                          <span
                            class="label label-light-success label-rounded font-weight-bolder"
                            >5</span
                          >
                        </span>
                      </a>
              ...
              >
                ...
                <div class="d-flex align-items-center mb-7">
                  ...
                  <div class="d-flex flex-column flex-grow-1">
                    <a
                      href="#"
                      class="text-dark text-hover-primary mb-1 font-size-lg font-weight-bolder"
                      >AirTicks Meeting</a
                    >
                    ...
                    >
                      ...
                      <ul class="navi navi-hover">
                        ...
                        <li class="navi-footer py-4">
                          <a
                            class="btn btn-primary font-weight-bold btn-sm px-5"
                            href="#"
                          >
