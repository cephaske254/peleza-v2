  ...
  <ul class="sticky-toolbar nav flex-column pl-2 pr-2 pt-3 pb-3 mt-4">
    ...
    >
      <a
        ...
        href="https://keenthemes.com/keen/?page=docs"
        target="_blank"
      >
        <span class="svg-icon svg-icon-lg">
    ...
    >
      <a
        class="btn btn-sm btn-icon btn-bg-light btn-icon-info btn-hover-danger"
        href="#"
        data-toggle="modal"
...
// KEEN THEME JAVASCRIPT FILES
// THE FILE IMPORTS THE REQUIRED JS FILES, TO SUPPORT KEEN THEME
import "./assets/js/keen.init";
import "./assets/js/layout/initialize";

import HeaderMobile from "./components/Keen/HeaderMobile.vue";
import UserPanel from "./components/Keen/UserPanel.vue";
import Dashboard from "./components/Keen/Dashboard.vue";
import DemoPanel from "./components/Keen/DemoPanel.vue";
import Aside from "./components/Keen/Aside.vue";
import Footer from "./components/Keen/Footer.vue";
import Header from "./components/Keen/Header.vue";
import QuickPanel from "./components/Keen/QuickPanel.vue";
import Scrolltop from "./components/Keen/Scrolltop.vue";
